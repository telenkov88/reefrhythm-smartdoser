...
compress(f"{args.path}/static/styles/cerulean", "*.css")
compress(f"{args.path}/static/styles/cyborg", "*.css")
compress(f"{args.path}/static/styles/darkly", "*.css")
compress(f"{args.path}/static/styles/minty", "*.css")
compress(f"{args.path}/static/styles/pulse", "*.css")
compress(f"{args.path}/static/styles/united", "*.css")
compress(f"{args.path}/static/styles/vapor", "*.css")
