 ...
 */
const findDate = (arr, date, reverse) => {
 ...
 */
const shiftMonth = (arr, date, operation, reset) => {
 ...
 */
const shiftDay = (arr, date, operation, reset) => {
 ...
 */
const shiftHour = (arr, date, operation, reset) => {
 ...
 */
const shiftMinute = (arr, date, operation, reset) => {
