 ...
 */
export function arrayToString(arr, options) {
    assertValidArray(arr);
    const parts = arr.map((part, idx) => arrayToStringPart(part, units[idx], Object.assign(Object.assign({}, defaultOptions), options)));
    return parts.join(" ");
}
/**
 ...
 */
export function getSchedule(arr, now, timezone) {
